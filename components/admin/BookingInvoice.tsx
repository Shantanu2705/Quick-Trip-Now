    ...
    <div id={id} className="bg-white w-[794px] p-[20mm] flex flex-col gap-10" style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}>
      ...
      <div className="relative z-10 flex flex-col">
        ...
        <div className="flex justify-between items-start pb-6 shrink-0">
          <div>
            <Logo variant="bare" className="h-12 w-48 origin-left" />
        ...
        <div className="grid grid-cols-2 gap-8 mt-4 border-t-2 border-slate-100 pt-6 break-inside-avoid">
          ...
          <div>
            ...
            <div className="bg-[#F582200D] p-4 rounded-xl border border-[#F582201A] h-full flex flex-col justify-center">
              <div className="flex justify-between items-center text-sm mb-3">
                <span className="text-[#F58220B3] font-bold uppercase tracking-wider text-[10px]">Booking ID:</span>
                <span className="font-mono font-black text-primary text-base">{booking.id}</span>
              </div>
              <div className="flex justify-between items-center text-sm pt-3 border-t border-[#F582201A]">
                <span className="text-[#F58220B3] font-bold uppercase tracking-wider text-[10px]">Date Issued:</span>
            ...
            <div className="space-y-4">
              {booking.itinerary.map((item: any, idx: number) => (
                <div key={idx} className="flex gap-4 items-start break-inside-avoid">
                  {item.day && (
                    <div className="shrink-0 bg-[#F582201A] text-primary w-10 h-10 rounded-lg flex items-center justify-center font-black text-sm border border-[#F5822033]">
                      D{item.day}
                    </div>
                  )}
