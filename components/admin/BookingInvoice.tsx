...
export function BookingInvoice({ booking, id }: BookingInvoiceProps) {
  ...
  return (
    <div id={id} className="absolute left-[-9999px] top-0 z-[-50] flex flex-col gap-10 bg-slate-100 p-10 font-sans" style={{ fontFamily: 'Inter, sans-serif' }}>
      
      {/* PAGE 1: Header, Customer, Trip Details */}
      <div className="invoice-page bg-white p-12 relative flex flex-col border-2 border-slate-300 overflow-hidden" style={{ width: '794px', height: '1123px' }}>
        {/* Watermark */}
        <div className="absolute inset-0 flex items-center justify-center opacity-[0.04] pointer-events-none">
          <Logo variant="bare" className="w-3/4 grayscale" />
        </div>
      ...
      {/* PAGE 2: Terms & Conditions and Footer */}
      {(booking.terms || (booking.inclusions && booking.inclusions.length > 0)) && (
        <div className="invoice-page bg-white p-12 relative flex flex-col justify-between border-2 border-slate-300 overflow-hidden" style={{ width: '794px', height: '1123px' }}>
          {/* Watermark */}
          <div className="absolute inset-0 flex items-center justify-center opacity-[0.04] pointer-events-none">
            <Logo variant="bare" className="w-3/4 grayscale" />
          </div>
          ...
          {/* Footer / Signature Block placed strictly at the bottom of Page 2 */}
          <div className="relative z-10 pt-8 border-t-2 border-slate-200 flex justify-between items-end bg-white">
